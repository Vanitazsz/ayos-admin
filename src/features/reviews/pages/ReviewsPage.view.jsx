    ...
    <div className="p-4 sm:p-6">
      <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center">
        <div>
          ...
          <p className="text-foreground-lighter mt-1">
            Completed bookings with worker feedback and proof photos
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 bg-card rounded-t-xl shadow-sm border-x border-t border-border p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="w-full sm:w-96">
          <Input
            icon={Search}
            aria-label="Search by worker, customer, service, or comment..."
            placeholder="Search by worker, customer, service, or comment..."
            value={searchTerm}
...
function ProofsTable({ isLoading, proofs, renderStars, onViewDetails }) {
  return (
            ...
            <TableRow hover={false}>
              <TableCell colSpan="8" className="text-center">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-lg font-medium text-foreground">No proof of work found</h3>
                </div>
              </TableCell>
            </TableRow>
          )}
